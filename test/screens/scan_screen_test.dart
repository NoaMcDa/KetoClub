...
void main() {
  group('ScanScreen', () {
    testWidgets('shows the localized placeholder title and body', (
      ...
      expect(find.text(_en.scanPlaceholderBody), findsOneWidget);
    });
    ...
    testWidgets('build under Locale(he) renders the Hebrew copy', (
      ...
      // Assert
      expect(find.text(_he.scanPlaceholderTitle), findsOneWidget);
      expect(find.text(_he.scanPlaceholderBody), findsOneWidget);
    });
  });
}
